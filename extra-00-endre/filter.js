...
/*******************************************************************************
* Complete the .filter method to filter out only the objects that have an      * 
* age from (and including) 26 to (and including) 28 and at least 3 hobbies     * 
*******************************************************************************/
const filteredPeople = people.filter( 
  ({ age : age, hobbies : { length : numHobbies } }) => {
    return age >= 26 && age <= 28 && numHobbies > 3;
});
...
/*******************************************************************************
* Filter out the objects who are male and have a name of exactly 6             * 
* characters                                                                   * 
*******************************************************************************/
const filteredPeople2 = people.filter(
  ({ male : male, name : { length : charsInName } }) => {
    return male && charsInName === 6;
});
...
*******************************************************************************/
const filteredPeople3 = people.filter( ({ hobbies : hobbies }) => {
